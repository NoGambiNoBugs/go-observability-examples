...
//go:generate gowrap gen -g -i CustomerUsecase -t ./templates/red_histogram_template.go.tmpl -o ./decorators/red/customer_usecase_with_red_histogram.go -v "Namespace=example"
